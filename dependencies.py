...
for subdir, dirs, files in os.walk(sys.argv[2]):
    for file in files:
       ...
       if rpm_regex.match(file):
           ...
           if header:
              dependencies[getDesc(header)] = getDeps(header)
...
provides = getProvides(readRpmHeader(ts, sys.argv[1]))
print sys.argv[1], "provides:"
for i in provides:
  print i
...
#    printDuplicates(packages)
#
#if arguments("-D"):
#    print "Checking Dependencies..."
#    printDeps(dependencies, packages, names)
